...
from .crimes import _async_do_poly_request, _async_resolve_poly, _do_poly_request, _resolve_poly
...
class StopSearchResource:
    ...
    def street(
        ...
        *,
        ...
        if poly is not None:
            raw: list[Any] = _do_poly_request(self._client, "stops-street", poly, params)
        else:
            if lat is not None:
                params["lat"] = str(lat)
            if lng is not None:
...
class AsyncStopSearchResource(StopSearchResource):
    ...
    async def street(  # type: ignore[override]
        ...
        *,
        ...
        if poly is not None:
            raw = await _async_do_poly_request(self._client, "stops-street", poly, params)  # type: ignore[arg-type]
        else:
            if lat is not None:
                params["lat"] = str(lat)
            if lng is not None:
